	...
	data = {
		...
		},
		{
			...
			text = {
				...
				'С понедельника по пятницу рабочий день с 9:00 до 20:00.',
				'В субботу и воскресенье рабочий день с 9:00 до 18:00.',
				'В не рабочее время или в обед сотрудник может покинуть офис Автошколы.',
				'Но перед этим обязательно нужно снять форму.',
				'Обед в будние идёт с 13:00 до 14:00.',
				'На этом у меня всё, спасибо за внимание.'
			}
		}
	}
...
local default_rules = {
	{
		...
		text = {
			'1. Общие положения.'
			'1.1 ГЦЛ - государственное заведение, обучающее жителей штата вождению, и занимается выдачей различного рода лицензий.'
			'1.2 Устав ГЦЛ - свод правил, положений, устанавливающий порядок деятельности сотрудников ГЦЛ, и регламентирующий действия '
			'сотрудников ГЦЛ.'
			'1.3 Не знание Устава ГЦЛ сотрудником, не освобождает его от ответственности. За нарушение устава в той или иной мере'
			'предусмотрено наказание от Устного предупреждения до увольнения сотрудника с занесением в черный список.'
			'1.4 Каждый сотрудник при необходимости должен помогать своим коллегам.'
			'1.5 В случае острой необходимости директора ГЦЛ имеет право нарушить устав.(Чрезвычайные ситуации, Глобальные происшествия в'
			'штате, неадекватные игроки угрожающие жизни игроков или сотрудников.)'
			' '
			'2. Обязанности сотрудников'
			'2.1 Все сотрудники ГЦЛ обязаны соблюдать субординацию, даже в случаи провокации со стороны граждан.'
			'2.2 Все сотрудники во время рабочего дня обязаны соблюдать дресс-код.'
			'2.3 Все сотрудники ГЦЛ, обязаны находится на территории ГЦЛ во время рабочего дня.'
			'Исключение: с разрешением директор, отгул, отпуск.'
			'2.4 Сотрудники имеет право отказать в обслуживании клиенту, если тот ведет себя не подобающе, или представляет угрозу здоровью'
			'сотрудников и окружающим.'
			' '
			'3. Запреты сотрудников ГЦЛ.'
			'3.1 Сотруднику ГЦЛ запрещено находится на рабочем месте с оружием.'
			'Исключение: кастет для самообороны.'
			'3.2 Сотруднику ГЦЛ запрещено превышать его должностные полномочия в ходе его работы.'
			'3.3 Сотрудникам младшего состава запрещено брать транспортные средства ГЦЛ без разрешения на то старшего состава ГЦЛ.'
			'3.4 Сотрудникам ГЦЛ запрещено работать на второстепенных работах во время рабочего дня который предусмотрен уставом ГЦЛ.'
			'3.5 Запрещено продавать лицензии людям у которых в паспорте опечатка.'
			'3.6 Сотрудникам ГЦЛ запрещено брать транспортные средства для использования в личных целях.'
			'3.7 Во время рабочего дня, запрещено посещать различного рода центрах развлечений, баров,'
			'3.8 Запрещено переманивать клиентов у других сотрудников автошколы.'
			'3.9 Запрещено в форме покидать рабочее место.'
			' '
			'4. Повышение сотрудников.'
			'4.1 Повышение сотрудников проходит в любое время, при наличии одобренного отчета и пройденного испытательного срока.'
			'4.2 Сотрудники с 1 по 3 ранг могут повышаться без ограничений, с 3-го ранг повышение будет проходить только 1 раз в день, при'
			'наличии отчета и пройденного испытательного срока.'
			'4.3 Сотрудники начиная с 5-го ранга не могут повышаться в должности при наличии выговоров.'
			'4.4 Запрещено напоминать руководящему составу о проверке отчетов.'
			' '
			'5. Испытательные сроки, увольнение и неустойки.'
			'5.1 Испытательные сроки'
			'С 1 на 2 ранг - интервал отсутствует'
			'С 2 на 3 ранг - интервал отсутствует'
			'С 3 на 4 ранг - интервал 1 день'
			'С 4 на 5 ранг - интервал 2 дня'
			'С 5 на 6 ранг - интервал 2 дня'
			'С 6 на 7 ранг - интервал 4 дня'
			'С 7 на 8 ранг - интервал 5 дня'
			'С 8 на 9 ранг - интервал 7 дня'
			'5.2 Сотрудники грубо нарушившие Устав ГЦЛ попадают в Черный Список.'
			'5.3 Жители штата которые нанесли какой либо вред работе ГЦЛ, сотрудникам и/или посетителям будут так-же занесены в Черный Список.'
			'(Исключение провокация со стороны граждан/сотрудников)''
			' '
			'6. Рабочий график.'
			'6.1 График работы с понедельника по субботу - 9:00 - 20:00'
			'6.2 График работы в выходные суббота/воскресенье - 9:00 - 18:00'
			'6.3 Обеденный перерыв в будние дни с 13:00 до 14:00'
			'6.4 Вечерний Перерыв(В субботу/Воскресенье отсутствует): 16:00 - 17:00'
			'6.5 В обеденное время, вне рабочее время, выходной день вы должны продавать лицензии по просьбе граждан.'
			'6.6 Директор ГЦЛ имеет полное право вызвать вас вне рабочее время если в ГЦЛ появилась очередь.'
			' '
			'7. Положение про отпуск.'
			'7.1 Каждый сотрудник имеет право на отпуск.'
			'7.2 Сотрудники старшего состава имеют право на долгосрочный отпуск до 10 дней.'
			'7.3 Сотрудники младшего состава имеют право только на кратковременный отпуск до 3-х дней.'
			'7.4 Отпуск разрешено брать с промежутком в 14 рабочих дней(возможны исключения).'
			'7.5 Во время отпуска сотрудникам запрещено устраиваться в другие организации.'
			'7.6 Сотрудник имеет право выйти из отпуска раньше положенного срока.'
			'7.7 Если сотрудник не явился на рабочее место спустя 2 дня после окончания отпуска его личное дело аннулируется, и сотрудник'
			'увольняется с последующим занесением в Черный список(На усмотрение директора).'
			'7.8 Во время отпуска, сотруднику запрещен нарушать закон и находится в сговоре с нелегальными организациями.'
			' '
			'8. Использование служебной рации.'
			'8.1 Служебная рация должно постоянно находится рядом с сотрудником.'
			'8.2 Сотруднику запрещено игнорировать обращение руководства.'
			'8.3 Сотрудникам запрещено что-либо рекламировать в служебную рацию.'
			'8.3.1 Сотрудникам запрещено создавать помехи, флудить, оскорблять, матерится в служебную рацию.'
			'Наказание: мут фракционного чата от 30 - 120 минут.'
		}
	},
	{
		...
		text = {
			...
			'Переводы осуществляются только по другим больницам [Без потери ранга, перевод доступен со 2+ ранга]'
			' '
			'Министерство Обороны:'
			'Перевод между Армиями и ТСР [Без потери ранга, перевод доступен с 3+ ранга]'
			'Перевод в Полицейские департаменты [-2 ранга, перевод доступен с 4+ ранга]'
			'Переводы в SWAT [На 1 ранг, перевод доступен с 5+ ранга]'
			' '
			'Министерство Юстиции:'
			'Перевод между Полицейскими департаментами [Без потери]'
			'Перевод в SWAT [С 3+ ранга на 1 ранг]'
			'Перевод в Министерство Обороны / ТСР [+1 ранг, начиная с 3 ранга]'
			'Федеральное бюро расследований - переводы отсутствуют'
			' '
			'Средства Массовой информации'
			'Переводы осуществляются только по другим СМИ [Без потери, перевод доступен с 3+ ранга]'
			' '
			'Центральный Аппарат и Правительство:'
			'Автошкола [Начиная с 3 ранга] - перевод в Правительство [-1 ранг], в ЦБ [-1 ранг], в Страховую Компанию [-1 ранг]'
			'Центральный банк [Начиная с 3 ранга] - перевод Правительство [-1 ранг], в Автошколу [-1 ранг], в Страховую Компанию [-1 ранг]'
			'Правительство [Начиная с 3 ранга] - перевод в Центральный Банк [Без потери], Автошколу [Без потери],'
			'в Страховую Компанию [Без потери]'
			'Страховая Компания [Начиная с 3 ранга] - перевод в Правительство [-1 ранг], в Центральный Банк [-1 ранг], в Автошколу [-1 ранг]'
			' '
			'» Если лидер/заместитель нарушит правило переводов, то лидер получит [2 Предупреждения]'
			' '
			'• Перевод может проходить максимум на 7й ранг, не более. •'
			'• 9й и 8й ранг переводятся только на 7й ранг. •'
			' '
			'Испытательный срок:'
			' '
			'С 1 на 2 ранг - повышение осуществляется без кд'
			'Со 2 на 3 ранг - повышение осуществляется без кд'
			'С 3 на 4 ранг - повышение осуществляется без кд'
			'С 4 на 5 ранг - повышение осуществляется без кд'
			'С 5 на 6 ранг - пробыть на должности 1 день'
			'С 6 на 7 ранг - пробыть на должности 2 дня'
			'С 7 на 8 ранг - пробыть на должности 2 дня'
			'С 8 на 9 ранг - пробыть на должности 4 дня'
			' '
			'Правила волны департамента:'
			' '
			...
			'Связи и координирования экстренных служб, во время терактов и ЧС.'
			'Контроля заполненности оружейных складов.'
			' '
			' '
			' '
			'В канале строго запрещается:'
			'Неадекватное поведение,маты.'
			'В канале запрещена реклама своих гос.организаций, бизнесов.'
			' '
			'Неформальное общение:'
			'? /d [MSP]-[LVPD] Доставьте бп по братски'
			' '
			'Несоблюдение метагейминга:'
			'? /d [MSP]-[LVPD] Не могу доставить вам боеприпасов, скоро оффнусь из игры.'
			' '
			'Создание OOC чата:'
			'? /d [LSN]-[SFN] (( Ребят я ща выходить буду, всем до завтра )).'
			'КОМАНДЫ /db НЕ СУЩЕСТВУЕТ, ЕСТЬ ТОЛЬКО /rb'
			' '
			...
			'? /d [GOV] - [PD/FBI] В мэрии вооруженное нападение, вышлите подкрепление срочно!'
			'? /d [FBI] - [SFA] Доставьте боеприпасов, наши склады пусты.'
			'? /d [DS] - [SFPD] Постройтесь в гараже, проверка лицензий.'
			'? /d [LSA] - [FBI] Фуры выехали к вам, ожидайте.'
			' '
			...
			'Бейджи имеют все сотрудники Пра-во, МЦ, ЦБ и АШ.'
			'[Все имена пишутся без нижнего подчеркивания "_"]'
			' '
			'? /d [GOV] -[MC] Ваш сотрудник скрылся с места ДТП. Номер машины 135.'
			'? /d [GOV] -[LSPD] Ваш сотрудник с жетоном 175 неправомерно забрал у меня права.'
			'? /d [FBI] - [LSPD] У вашего бойца с жетоном 100, при обыске найдены наркотические средства.'
			' '
			' '
			' '
			'Для Правительства,Мин.Юстиций и Обороны существует специальный закрытый канал общения(з.к.)'
			'Закрытый канал слышит только та фракция, к которой обратились.'
			'ФБР имеет возможность прослушивать закрытый канал, перед этим отыгрыв РП ситуацию с подключением к каналу'
			'Полный список фракция имеющих доступ к закрытому каналу:'
			'ЛСПД,СФПД,ЛВПД,РКШД'
			'СФа,ЛСа,ТСР'
			'ФБР'
			'Правительство(только губернатор/зам.губернатора)'
			'Пример:'
			'? /d [FBI]з.к.[PD/FBI] Поступила информация о подготовке терракта. Будьте готовы'
			'? /d [LSPD]з.к.[SFPD] Шеф, прием. Нам срочно нужно встретиться.			'
		}
	}
}
		...
		if windows.imgui_fm.v then
			...
			if windowtype == 8 then
				...
				if imgui.Button(u8'Рабочее время в будние дни', imgui.ImVec2(285,30)) then
					if not inprocess then
						ASHelperMessage('Подсказка: 09:00 - 20:00')
				...
				if imgui.Button(u8'Рабочее время в выходные дни', imgui.ImVec2(285,30)) then
					if not inprocess then
						ASHelperMessage('Подсказка: 9:00 - 18:00')
				...
				imgui.SetCursorPosX((imgui.GetWindowWidth() - 285) / 2)
				if imgui.Button(u8'Повышение с выговором', imgui.ImVec2(285,30)) then
					if not inprocess then
						ASHelperMessage('Подсказка: Нет.')
						sampSendChat('Можно ли повышаться имея выговор?')
						lastq = os.clock() - 1
					else
						ASHelperMessage('Не торопитесь, вы уже отыгрываете что-то!')
					end
				...
				imgui.SetCursorPosX((imgui.GetWindowWidth() - 285) / 2)
				if imgui.Button(u8'Промежуток между отпусками', imgui.ImVec2(285,30)) then
					if not inprocess then
						ASHelperMessage('14 дней')
						sampSendChat('Скажите, какой промежуток должен быть между отпусками у одного сотрудника?')
						lastq = os.clock() - 1
					else
						ASHelperMessage('Не торопитесь, вы уже отыгрываете что-то!')
					end
				...
				imgui.SetCursorPosX((imgui.GetWindowWidth() - 285) / 2)
				if imgui.Button(u8'Что такое ГЦЛ', imgui.ImVec2(285,30)) then
					if not inprocess then
						ASHelperMessage('Подсказка: ГЦЛ - государственное заведение, занимается выдачей различного рода лицензий.')
						sampSendChat('Что по вашему мнению означает слово \'ГЦЛ\'?')
						lastq = os.clock() - 1
					else
						ASHelperMessage('Не торопитесь, вы уже отыгрываете что-то!')
					end
...
function checkbibl()
	...
	downloadUrlToFile('https://raw.githubusercontent.com/Just-Mini/Gilbert/main/update.ini', 'moonloader/updateashelper.ini', function(id, status)
		if status == dlstatus.STATUSEX_ENDDOWNLOAD then
			if doesFileExist('moonloader/updateashelper.ini') then
	...
	if doupdate then
		DownloadFile('https://raw.githubusercontent.com/Just-Mini/Gilbert/main/AS%20Helper%20for%20Gilbert.lua', thisScript().path)
		NoErrors = true
